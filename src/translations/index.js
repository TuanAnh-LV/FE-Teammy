export const translations = {
  EN: {
    ...
    accepted: "Accepted",
    viewGroupDetails: "View Group Details",
    noGroupsBeingMentored: "No groups being mentored yet",
    searching: "Searching...",
  },
  ...
  VIE: {
    ...
    availableSkills: "Kỹ năng có sẵn (Nhấp để thêm)",
    ...
    mentorAssigned: "Mentor được gán",
    selectMentorForTopic: "Chọn mentor cho chủ đề này",
    assignMentorToTopic: "Gán Mentor cho Chủ Đề",
    semester: "Học kỳ",
    pending: "Chờ xử lý",
    remaining: "Còn lại",
    noDescription: "Không có mô tả",
    ...
    viewGroupDetails: "Xem chi tiết nhóm",
    noGroupsBeingMentored: "Chưa có nhóm nào đang hướng dẫn",
    ...
    subtasksTitle: "Công việc",
    cancelParticipation: "Hủy tham gia",
    assignTask: "Phân công",
    justNow: "vừa xong",
    minutesAgo: "phút trước",
    hoursAgo: "giờ trước",
    daysAgo: "ngày trước",
    whatNeedsToBeDone: "Cần làm gì?",
    newTask: "Nhiệm vụ mới",
    member: "Thành viên",
    unassigned: "Chưa gán",
    deleteColumnTitle: "Xóa cột",
    confirmDelete: "Xác nhận xóa",
    sinh_vien: "sinh viên",
    thanh_vien: "thành viên",
    
    // Missing admin/user management translations
    ...
    confirmBanContent: "Bạn có chắc chắn muốn cấm người dùng này? Hành động này có thể được hoàn tác sau.",
    confirmBanOk: "Xác nhận cấm",
    confirmBanCancel: "Hủy",
    userBannedSuccess: "{name} đã bị cấm.",
    userBanFailed: "Không thể cấm {name}",
    createRecruitPostSuccess: "Bài tuyển dụng đã được tạo",
    createProfilePostSuccess: "Bài hồ sơ đã được tạo",
  },
};
